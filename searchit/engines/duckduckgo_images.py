...
from searchit.base import BaseSearchEngine
from searchit.results import ImagesResult
from searchit.utils import _extract_vqd
...
class DuckduckgoImages(BaseSearchEngine[ImagesResult]):
    ...
    def _get_vqd(self, query: str) -> str:
        ...
        resp_content = self.client.request("GET", "https://duckduckgo.com", params={"q": query}).content
