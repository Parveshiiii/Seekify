...
def _print_data(data: list[dict[str, str]], *, no_color: bool = False) -> None:
    if data:
        for i, e in enumerate(data, start=1):
            ...
            # Removed input() to allow non-interactive usage and piping
...
def text(
    ...
    *,
    ...
    """CLI function to perform a Searchit text metasearch."""
    data = Search(proxy=_expand_proxy_tb_alias(proxy), verify=verify).text(
        query=query,
...
def images(
    ...
    *,
    ...
    """CLI function to perform a Searchit images metasearch."""
    data = Search(proxy=_expand_proxy_tb_alias(proxy), verify=verify).images(
        query=query,
        keywords=keywords,  # deprecated
        region=region,
        safesearch=safesearch,
...
def videos(
    ...
    *,
    ...
    """CLI function to perform a Searchit videos metasearch."""
    data = Search(proxy=_expand_proxy_tb_alias(proxy), verify=verify).videos(
        query=query,
        keywords=keywords,  # deprecated
        region=region,
        safesearch=safesearch,
...
def news(
    ...
    *,
    ...
    """CLI function to perform a Searchit news metasearch."""
    data = Search(proxy=_expand_proxy_tb_alias(proxy), verify=verify).news(
        query=query,
        keywords=keywords,  # deprecated
        region=region,
        safesearch=safesearch,
...
def books(
    ...
    *,
    ...
    """CLI function to perform a Searchit books metasearch."""
    data = Search(proxy=_expand_proxy_tb_alias(proxy), verify=verify).books(
        query=query,
        keywords=keywords,  # deprecated
        max_results=max_results,
        page=page,
