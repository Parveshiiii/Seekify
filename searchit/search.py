...
class Search:
    """Searchit - A metasearch library for simple and distributed search.
    ...
    def __init__(self, proxy: str | None = None, timeout: int | None = 5, *, verify: bool | str = True) -> None:
        self._proxy = _expand_proxy_tb_alias(proxy) or os.environ.get("SEARCHIT_PROXY")
    ...
    def get_executor(cls) -> ThreadPoolExecutor:
        ...
        if cls._executor is None:
            cls._executor = ThreadPoolExecutor(max_workers=cls.threads, thread_name_prefix="Searchit")
